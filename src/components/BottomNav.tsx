...
import { Droplets, PlusCircle, ClipboardList, Package, FileText, Truck, BarChart3, Hammer, ListChecks } from "lucide-react";
...
const navItems = [
  ...
  { path: "/planos-manutencao", icon: ListChecks, label: "Planos", title: "Planos de Manutenção" },
